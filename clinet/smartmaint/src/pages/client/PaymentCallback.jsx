  ...
  return (
    <main style={{ minHeight: '100vh', background: '#F7F7F5', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ background: '#FFFFFF', borderRadius: 24, boxShadow: '0 18px 36px rgba(0,0,0,0.08)', padding: '2rem', maxWidth: 500, width: '100%', textAlign: 'center' }}>
        <p style={{ margin: 0, color: '#4285F4', fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.14em' }}>Payment status</p>
        ...
        <button
          ...
          style={{ marginTop: 20, border: 'none', background: '#4285F4', color: '#FFFFFF', borderRadius: 9999, padding: '0.8rem 1rem', fontWeight: 700, cursor: 'pointer' }}
        >
